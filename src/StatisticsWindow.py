...
class StatisticsWindow(QDialog):
    ...
    def __setupUIForStatistics(self, generalStats: GeneralMatchStatistics, killerStats: KillerMatchStatistics, survivorStats: SurvivorMatchStatistics):
        ...
        leastCommonMapLayout = QHBoxLayout()
        leastCommonRealmLayout = QHBoxLayout()
        ...
        mostCommonMapLayout.addWidget(mostCommonMapInfoLabel)
        mostCommonMapLayout.addWidget(mostCommonMapLabel)
        mostCommonMapLayout.setContentsMargins(*margins)
        mostCommonMapLayout.setAlignment(mostCommonMapInfoLabel, Qt.AlignLeft)
        mostCommonMapLayout.setAlignment(mostCommonMapLabel, Qt.AlignRight)
        mostCommonRealmLayout.addWidget(mostCommonRealmInfoLabel)
        mostCommonRealmLayout.addWidget(mostCommonRealmLabel)
        mostCommonRealmLayout.setContentsMargins(*margins)
        mostCommonRealmLayout.setAlignment(mostCommonRealmInfoLabel, Qt.AlignLeft)
        mostCommonRealmLayout.setAlignment(mostCommonRealmLabel, Qt.AlignRight)
        leastCommonMapLayout.addWidget(leastCommonMapInfoLabel)
        leastCommonMapLayout.addWidget(leastCommonMapLabel)
        leastCommonMapLayout.setContentsMargins(*margins)
        leastCommonMapLayout.setAlignment(leastCommonMapInfoLabel, Qt.AlignLeft)
        leastCommonMapLayout.setAlignment(leastCommonMapLabel, Qt.AlignRight)
        leastCommonRealmLayout.addWidget(leastCommonRealmInfoLabel)
        leastCommonRealmLayout.addWidget(leastCommonRealmLabel)
        leastCommonRealmLayout.setContentsMargins(*margins)
        leastCommonRealmLayout.setAlignment(leastCommonRealmInfoLabel, Qt.AlignLeft)
        leastCommonRealmLayout.setAlignment(leastCommonRealmLabel, Qt.AlignRight)
        ...
        totalPointsLayout.addWidget(totalPointsInfoLabel)
        totalPointsLayout.addWidget(pointsLabel)
        totalPointsLayout.setAlignment(totalPointsInfoLabel, Qt.AlignLeft)
        totalPointsLayout.setAlignment(pointsLabel, Qt.AlignRight)
        totalPointsLayout.setContentsMargins(*margins)
        averagePointsLayout.addWidget(avgPointsInfoLabel)
        averagePointsLayout.addWidget(avgPointsLabel)
        averagePointsLayout.setAlignment(avgPointsInfoLabel, Qt.AlignLeft)
        averagePointsLayout.setAlignment(avgPointsLabel, Qt.AlignRight)
        averagePointsLayout.setContentsMargins(*margins)
        gamesLayout.addWidget(gamesInfoLabel)
        gamesLayout.addWidget(gamesLabel)
        gamesLayout.setAlignment(gamesInfoLabel, Qt.AlignLeft)
        gamesLayout.setAlignment(gamesLabel, Qt.AlignRight)
        gamesLayout.setContentsMargins(*margins)
        generalStatsLayout.addLayout(gamesLayout)
        generalStatsLayout.addLayout(totalPointsLayout)
        generalStatsLayout.addLayout(averagePointsLayout)
        generalStatsLayout.addLayout(mostCommonMapLayout)
        generalStatsLayout.addLayout(mostCommonRealmLayout)
        generalStatsLayout.addLayout(leastCommonMapLayout)
        generalStatsLayout.addLayout(leastCommonRealmLayout)
